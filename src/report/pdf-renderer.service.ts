...
import { TemplateSchema, TemplateElement } from './interfaces/report.interfaces';
...
export class PdfRendererService {
     ...
     */
    private renderElement(doc: PDFKit.PDFDocument, element: TemplateElement, data: Record<string, any>) {
     ...
     * Render text element
     */
    private renderText(doc: PDFKit.PDFDocument, element: TemplateElement, x: number, y: number) {
     ...
     */
    private renderImage(doc: PDFKit.PDFDocument, element: TemplateElement, x: number, y: number) {
     ...
     */
    private renderShape(doc: PDFKit.PDFDocument, element: TemplateElement, x: number, y: number) {
