...
export class LaporanService {
    ...
    async generateMutasiSimpanan(params: { startDate: Date; endDate: Date; productType: string; format: 'PDF' | 'EXCEL' }) {
        let data: any[] = [];
        let title = '';
    ...
    async generateDaftarRekening(params: { productType: string; format: 'PDF' | 'EXCEL' }) {
        let data: any[] = [];
        let title = '';
