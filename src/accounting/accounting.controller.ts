...
export class AccountingController {
  ...
  getAccounts(
    ...
    console.log(
      'GET /accounting/accounts hit. Type:',
      type,
      'Page:',
      page,
      'Limit:',
  ...
  updateAccount(
    ...
    @Body() data: Prisma.JournalAccountUpdateInput,
  ) {
  ...
  updateMapping(
    ...
    return this.accountingService.updateMapping(
      transType,
      body.debitAccount,
      body.creditAccount,
    );
  ...
  async deleteJournal(
    ...
    try {
      ...
      return await this.accountingService.deleteJournal(
        Number(id),
        Number(userId),
  ...
  getDailyReport(@Query('date') date?: string) {
    return this.accountingService.getDailyReportData(
