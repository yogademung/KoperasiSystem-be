...
export class SystemDateService {
     ...
     */
    async advanceBusinessDate(): Promise<{ success: boolean; newDate?: Date; message: string }> {
        ...
        console.log(`✅ Business date advanced: ${format(currentBusinessDate, 'yyyy-MM-dd')} → ${format(nextBusinessDate, 'yyyy-MM-dd')}`);
